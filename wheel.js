...
const prizes = [
    ...
    { emoji: "🎤", title: "BTS Concert Ticket!", text: "A front-row virtual seat to your favorite BTS comeback stage." },
    { emoji: "🎬",  title: "K-Drama Marathon!", text: "One year of unlimited K-drama & anime binge-watching, on the house." },
...
prizes.forEach((prize, i) => {
    ...
    svgMarkup += `<path d="M${cx},${cy} L${start.x},${start.y} A${r},${r} 0 ${largeArc},1 ${end.x},${end.y} Z" fill="${colors[i % 2]}" stroke="#0d120e" stroke-width="2"/>`;
